...
public class AudioUtil {
    ...
    private LameJniUtil lameJni;
    private AudioUtil(Builder builder) {
        mSampleRate=builder.sampleRate;
        mChannel=builder.channel;
        mFormat=builder.format;
        lameJni=new LameJniUtil();
    ...
    public static class Builder{
        ...
        public AudioUtil create(){
            return new AudioUtil(this);
        }
    }
